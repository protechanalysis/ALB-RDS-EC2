...
module "load_balancer" {
  source     = "git::https://github.com/protechanalysis/terraform-aws-module.git//aws_modules/load_balancer/application/?ref=v1.2.1"
  vpc_id     = module.vpc.vpc_id
  name       = "${local.name}-alb"
  ...
  instance_ids = [module.ec2_instance_1.instance_id, module.ec2_instance_2.instance_id]
